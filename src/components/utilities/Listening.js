...
const Listening = () => {
    return (
        <div>
            <div className="mic-listening-container">
                <div className="mic-listening-helper">
                    <div className="mic-listening">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <defs>
                            <linearGradient id="MyGradient">
                                <stop offset="0%" stopColor="rgb(54,69,71)" />
                                <stop offset="100%" stopColor="rgb(255,226,104)" />
                            </linearGradient>
                        </defs>
                        ...
                        <span className="mic-listening-text">Listening</span>
                    </div>
                </div>
            </div>
        </div>
