      ...
      {isModalOpen ? (
        <GenericModal closeModal={handleCloseModalClick}>
          <div className="privacy-statement">
            ...
            <p>Our website address is: https://sleekbuys.com.</p>
            ...
            <p>
              Like any other website, SleekBuys uses ‘cookies’. These cookies are used to store information including
            ...
            <p>
              SleekBuys does not knowingly collect any Personal Identifiable Information from children under the age of
